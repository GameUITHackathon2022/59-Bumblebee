namespace Dialogue
{
    ...
    public class RichTextTag
    {
        ...
        private const char OPEN_DELIMITER = '<';
        private const char CLOSE_DELIMITER = '>';
        ...
        public string TagType
        {
            get
            {
                ...
                tagType = tagType.TrimStart(END_DELIMITER);

                var tagEndDelimeters = new char[] { ' ', PARAM_DELIMITER };
        ...
        public string Parameter
        {
            get
            {
                var parameterDelimeterIndex = this.TagText.IndexOf(PARAM_DELIMITER);
        ...
        public bool IsClosingTag
        {
            get
            {
                return this.TagText.Length > 2 && this.TagText[1] == END_DELIMITER;
            }
        }
        ...
        {
            return text.StartsWith(RichTextTag.OPEN_DELIMITER.ToString());
        }
        ...
        public static RichTextTag ParseNext(string text)
        {
            ...
            var openingDelimeterIndex = text.IndexOf(RichTextTag.OPEN_DELIMITER);
            ...
            var closingDelimeterIndex = text.IndexOf(RichTextTag.CLOSE_DELIMITER);
